...
<meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    ...
    <link type="text/css" rel="stylesheet" href="Assets/backend/css/font-awesome.css">
    <link type="text/css" rel= "stylesheet" href="Assets/backend/css/admin-login.css">
    <style>
        p{
            font-size: 20px;
            color: blue;
...
<body>
    ...
    <!-- global js -->
    <link href="Assets/backend/js/jquery.min.js" type="text/javascript">
	...
	if (isset($_POST['login']))
		{
			...
			$query 		= mysqli_query($con, "SELECT * FROM admin WHERE  password='$pass_md5' and username='$username'");
